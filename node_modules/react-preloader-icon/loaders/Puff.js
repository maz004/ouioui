...
var bezier_easing_1 = tslib_1.__importDefault(require("bezier-easing"));
var react_1 = tslib_1.__importStar(require("react"));
var loop_1 = tslib_1.__importDefault(require("../utils/loop"));
var spread = bezier_easing_1.default(0.165, 0.84, 0.44, 1);
var fade = bezier_easing_1.default(0.3, 0.61, 0.355, 1);
function useWave(radius, duration) {
    var ref = react_1.useRef();
    react_1.useEffect(function () {
        var circles = ref.current.querySelectorAll('circle');
        return loop_1.default({
            duration: duration,
            update: function (n) {
...
var Puff = function (_a) {
    ...
    var radius = react_1.useMemo(function () { return 50 - strokeWidth / 2; }, [strokeWidth]);
